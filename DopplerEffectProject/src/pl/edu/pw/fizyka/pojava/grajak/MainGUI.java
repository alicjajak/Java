...
public class MainGUI extends JFrame {
	...
	public MainGUI() throws HeadlessException {
		...
		labelDoCalculations = new JLabel("Wyniki obliczeĹ„");
		labelDoCalculations.setFont(new Font("default", Font.BOLD, 16));
		labelFrequency = new JLabel("CzÄ™stotliwoĹ›Ä‡ dzwiÄ™ku sĹ‚yszanego przez odbiorcÄ™");
		labelWavelength = new JLabel("Fala");
		labelEmpty = new JLabel("");
		labelEmpty2 = new JLabel("");
		labelSpeed = new JLabel("Obliczenia zostaĹ‚y wykonane dla prÄ™dkoĹ›ci dzwiÄ™ku w powietrzu V=340m/s");
		...
		labelInfo = new JLabel("	Tutaj bÄ™dzie rysowany wykres");
